                                        ...
                                        return  (
                                            <Form.Item key={index}>
                                                <div style={{display:'flex',justifyContent: 'space-around'}}>
                                                    {
                                                        ()=>{
                                                            for(let i=0;i<this.store.unSelectablePoint.length;i++){
                                                                if(this.store.unSelectablePoint[i] === col.colName){
                                                                    return(
                                                                        <React.Fragment>
                                                                ...
                                                                else if(this.store.unSelectablePoint[i] !== col.colName && i === this.store.unSelectablePoint.length-1){
                                                                    return(
                                                                        <React.Fragment>
                                                                            <Form.Item name={col.colName} noStyle valuePropName="checked">
