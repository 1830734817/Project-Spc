      ...
      <div className='container'>
        ...
        <div className='search_bar'>
          ...
          <Button type="primary" icon={<PlusOutlined />}
            style={{ margin: '0 10px 10px 0', padding:'0 30px', verticalAlign: 'middle'}}
          >
            添加
          </Button>
          ...
          <Dropdown overlay={deleteMenu} placement="bottomLeft" >
            <Button icon={<DeleteOutlined />} style={{ margin: '0 10px 10px 0', verticalAlign: 'middle'}}>
              删除<DownOutlined />
            </Button>
          </Dropdown>

          {/* 筛选条件 */}
          <Button icon={<FilterOutlined />} style={{right:'200px', margin: '0 10px 10px 0', verticalAlign: 'middle'}}>
            筛选条件
          </Button>

          {/* 排序 */}
          <Button icon={<SortDescendingOutlined />} style={{ margin: '0 10px 10px 0', verticalAlign: 'middle'}}/>
