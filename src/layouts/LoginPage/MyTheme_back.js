...
class LoginPage extends React.Component {
  ...
  render() {
    return (
      <div className='login_container2' style={{backgroundImage:'url('+loginbkg+')'}}>
        <div className='login_form2'>
          <div className='basic_login2'>
            {/* 云栖智造 */}
            {/* div 大小(高度由图片决定): (900-190) * 55 */}
            {/* div 下方边距：40 */}
            {/* minalogo: 210 * 55 */}
            {/* marginBottom: 40 === margin: 0 0 40 */}
            {/* marginBottom：React JSX style 属性表示方法，对应CSS margin_bottom */}
