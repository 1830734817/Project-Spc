			...
			if (sideMenuObj){
				if(sideMenuObj[0].childMenu){
					if(sideMenuObj[0].childMenu[0].childMenu){
						...
						this.props.HomeStore.setFirstSelectedItem(sideMenuObj[0].childMenu[0].childMenu[0].id);
					    console.log(this.props.HomeStore.firstSelectedItem)
					}
					else{
						path='/spcData/'+sideMenuObj[0].childMenu[0].uuid;
						this.props.HomeStore.setCurrentUuid(sideMenuObj[0].childMenu[0].uuid);
						this.props.HomeStore.setFirstSelectedItem(sideMenuObj[0].childMenu[0].id);
					    console.log(this.props.HomeStore.firstSelectedItem)
					...
					this.props.HomeStore.setFirstSelectedItem(sideMenuObj[0].id);
					console.log(this.props.HomeStore.firstSelectedItem)
