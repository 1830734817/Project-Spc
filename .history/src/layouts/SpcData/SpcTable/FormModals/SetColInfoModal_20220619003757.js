...
class SetColInfoModal extends Component {
    ...
    return (
      ...
      >
        <Form
          ...
          ref={this.formRef}
          initialValues={{
                  colInfo_1:this.store.colInfo[0].colName,
                  colInfo_2:this.store.colInfo[1].colName,
                  colInfo_3:this.store.colInfo[2].colName,
                  colInfo_4:this.store.colInfo[3].colName,
                  colInfo_5:this.store.colInfo[4].colName,
                  colInfo_6:this.store.colInfo[5].colName,
                  colInfo_7:this.store.colInfo[6].colName,
                  colInfo_8:this.store.colInfo[7].colName,
                  colInfo_9:this.store.colInfo[8].colName,
          }}
        >
  ...
  componentDidMount = ()=>{
    // toJS(this.store.colInfo).length)
    //显示已定义的层次类型
