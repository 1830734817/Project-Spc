...
class Spc{
    ...
    @action async saveColInfo(params){
        ...
        //todo:1、重新获取colinfo2、刷新表格列
    }

    /* 增加层次类型备选值 */
    @action addAlternative(params){
        let t = this.tempColInfo[this.colInfoIndex].colValues.push(params);
        console.log(toJS(t),toJS(this.tempColInfo))
    }
